...
textual_responses_file = "tabular_TESTSET_RESPONSES.xlsx"  # File with generated responses
textual_testset_file = "tabular_TESTSET_FINAL.xlsx"  # File with English questions and correct answers
output_excel_path = "tabular_COMET_evaluation.xlsx"
...
source_ans_en = df_responses['Tabular Responses'].tolist()  # Generated responses (English)
...
# Save the plot
plt.savefig('tabular_comet_scores_visualization.png')
plt.show()
