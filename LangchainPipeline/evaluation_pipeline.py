...
textual_responses_file = "tabular_responses_gemma_better.xlsx"  # File with generated responses
textual_testset_file = "tabular_TESTSET_FINAL.xlsx"  # File with English questions and correct answers
output_excel_path = "tabular_COMET_gemma_better.xlsx"
...
# Save the plot
plt.savefig('tabular_comet_scores_gemma_better_visualization.png')
plt.show()
